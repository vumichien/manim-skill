...
argument-hint: --idea \"<topic>\" | --paper <id-or-url> | --math \"<topic>\" [--voice gtts|openai|elevenlabs] [--no-voice] [--no-chrome] [--transition-s 0.7] [--quality low|medium|high|4k] [--storyboard-only] [--out <dir>]
---
